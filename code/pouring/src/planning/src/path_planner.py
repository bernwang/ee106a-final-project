...
class PathPlanner(object):
    ...
    def __init__(self, group_name):
        ...
        #set the en
        #self._group.set_end_effector_link("right_gripper")
    ...
    def plan_to_angle(self, angles, orientation_constraints):


        self._group.set_joint_value_target(angles)
    ...
    def rotate_Wrist(self):
        t = self._scene.get_current_joint_values()
        print(t)
